        ...
        <main className="flex-1 flex flex-col bg-[#F8F9FD] relative overflow-hidden">
            {!isSidebarVisible && (
              <button
                ...
                className="absolute left-0 top-32 z-50 w-9 h-24 bg-indigo-600 text-white flex items-center justify-center pl-1 rounded-r-2xl shadow-xl transition-all active:scale-95 hover:translate-x-1"
              >
